...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!db.Productos.Any())
    {
        ...
        {
            new Producto { Nombre = "Celular Galaxy A54", Descripcion = "Celular Samsung 128GB", Precio = 190000, Stock = 10, ImageUrl = "https://imgs.search.brave.com/LaLRpDspuUpj9USNOkcKXx4Jgm99wY3O9zS3z8AIMCs/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/bGVzbnVtZXJpcXVl/cy5jb20vb3B0aW0v/cHJvZHVjdC83MS83/MTk3MS85YjU3YWQw/OC1nYWxheHktYTU0/X180MDBfNDAwLmpw/Zw" },
            new Producto { Nombre = "Celular iPhone 13", Descripcion = "Apple iPhone 13 256GB", Precio = 420000, Stock = 5, ImageUrl = "https://imgs.search.brave.com/aoxrpNi0vTljtdxmNM4WmsYsq6vftQtByDl0chNHr7g/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90aWVu/ZGEucGVyc29uYWwu/Y29tLmFyL2ltYWdl/cy83MjAvd2VicC9p/X1Bob25lXzEzX1By/b18yNTZfR0JfR3Jh/cGhpdGVfNzNmM2Uw/NmQxYy5wbmc" },
            new Producto { Nombre = "Cargador USB-C", Descripcion = "Cargador rápido 20W", Precio = 7000, Stock = 30, ImageUrl = "https://imgs.search.brave.com/hmXX10qrpBgPf9pdr2tS10AkXFlA7-PhUk7H5CB1hvs/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9odHRw/Mi5tbHN0YXRpYy5j/b20vRF9RX05QXzJY/Xzg0Njg3Ni1NTFU3/NTg1NTU4ODU1N18w/NDIwMjQtVi53ZWJw" },
            new Producto { Nombre = "Auriculares Bluetooth", Descripcion = "Auriculares inalámbricos", Precio = 15000, Stock = 25, ImageUrl = "https://imgs.search.brave.com/NrkV8_8ym_q582Nb4t9CjbSkMRFulRNzV47T7zIBMLQ/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90aWVu/ZGEucGVyc29uYWwu/Y29tLmFyL2ltYWdl/cy83MjAvd2VicC9B/dXJpY3VsYXJlc19C/bHVldG9vdGhfRm94/Ym94X09wZW5haXJf/Q2xpcF9jMTdlY2Ux/ZWJhLnBuZw" },
            new Producto { Nombre = "Smartwatch", Descripcion = "Reloj inteligente con GPS", Precio = 25000, Stock = 12, ImageUrl = "https://imgs.search.brave.com/ICfA_LH4vnplJ6q30uPq2RSeFR6ro0m4XodiDM_baSw/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/dGl0YW4uY28uaW4v/ZHcvaW1hZ2UvdjIv/QktERF9QUkQvb24v/ZGVtYW5kd2FyZS5z/dGF0aWMvLS9TaXRl/cy10aXRhbi1tYXN0/ZXItY2F0YWxvZy9k/ZWZhdWx0L2R3YTZj/OGE5MWUvaW1hZ2Vz/L0Zhc3RyYWNrL0Nh/dGFsb2cvMzgxMjNR/TTAxXzQuanBnP3N3/PTM2MCZzaD0zNjA" },
            new Producto { Nombre = "Notebook Lenovo", Descripcion = "Laptop 15.6'' 8GB RAM", Precio = 320000, Stock = 7, ImageUrl = "https://imgs.search.brave.com/442IklAxpbCqzYRhJ_mYwoHHJiPfp1Ou5abe1kJTHPE/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9odHRw/Mi5tbHN0YXRpYy5j/b20vRF9RX05QXzJY/Xzg2MTgxMy1NTFU3/NzEyNjkxNTYxOF8w/NjIwMjQtRS53ZWJw" },
            new Producto { Nombre = "Gaseosa Coca-Cola 2L", Descripcion = "Botella 2 litros", Precio = 1000, Stock = 50, ImageUrl = "https://imgs.search.brave.com/cMOCtFIHhrcTIWd-pQMVnZihbOLYs-LQ2qa10p2-q8I/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9hbmRp/bmFjb2NhY29sYWFy/LnZ0ZXhhc3NldHMu/Y29tL2FycXVpdm9z/L2lkcy8xNTYyMjMt/ODAwLTgwMD92PTYz/ODU3MDE1NTkyNDM3/MDAwMCZ3aWR0aD04/MDAmaGVpZ2h0PTgw/MCZhc3BlY3Q9dHJ1/ZQ" },
            new Producto { Nombre = "Gaseosa Pepsi 2L", Descripcion = "Pepsi 2 litros", Precio = 950, Stock = 45, ImageUrl = "https://imgs.search.brave.com/ZAjNsfIYrtqJy0RJdPHH8s4Omy0mSAXevb8c6LRD_Gc/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tLm1l/ZGlhLWFtYXpvbi5j/b20vaW1hZ2VzL0kv/NTFZRTlqcFNjUkwu/anBn" },
            new Producto { Nombre = "Chocolate Milka", Descripcion = "Chocolate con leche 100g", Precio = 800, Stock = 100, ImageUrl = "https://imgs.search.brave.com/DEMGPd55d7BrAkVxOlP0FIyr9JYIjIPJfRLNWkuL_oM/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzA1LzQyLzgwLzY3/LzM2MF9GXzU0Mjgw/Njc1NV93OXd2RmNM/aHo2QnpEbUVrQmtH/bGhGTjM5eWtjUlhs/ci5qcGc" },
            new Producto { Nombre = "Papas Lays", Descripcion = "Bolsa de papas fritas 200g", Precio = 1200, Stock = 60, ImageUrl = "https://imgs.search.brave.com/_2c-50Qz6ktaToRAjHUjhqBUMMh2iPiq7jyklAmDW84/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90dXN1/cGVyLmNvbS5hci9p/bWFnZS9jYWNoZS9j/YXRhbG9nL1AyMDIz/L0RpY2llbWJyZSUy/MDE2L1BhcGFzLUZy/aXRhcy1DbGFzaWNh/cy1MYXlzLTg1LUdy/LTEtMTY5NzAlMjAo/MSklMjAoMSktNjAw/eDYwMC5qcGc" },
        };
