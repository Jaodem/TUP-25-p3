...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!db.Productos.Any())
    {
        var productosIniciales = new List<Producto>
        {
            ...
            new Producto { Nombre = "Chocolate Milka", Descripcion = "Chocolate con leche 100g", Precio = 800, Stock = 100, ImagenUrl = "https://imgs.search.brave.com/DEMGPd55d7BrAkVxOlP0FIyr9JYIjIPJfRLNWkuL_oM/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzA1LzQyLzgwLzY3/LzM2MF9GXzU0Mjgw/Njc1NV93OXd2RmNM/aHo2QnpEbUVrQmtH/bGhGTjM5eWtjUlhs/ci5qcGc" },
